...
class Settings(Base):
    ...
    disable_thinking = Column(Boolean, default=False, server_default="0", nullable=False, comment="是否关闭模型思考（开启后思考型模型跳过思考阶段直接输出正文）")
    ...
    smtp_from_name = Column(String(255), default="AIFictionForge", server_default="AIFictionForge", nullable=False, comment="发件人名称")
