...
class PostgreSQLSetup:
    ...
    def __init__(
        ...
        db_name: str = "aistoryforge",
        db_user: str = "aistoryforge",
...
╚═══════════════════════════════════════════════════════════════╝
    ...
    print("\n请输入要创建的数据库信息:\n")
    db_name = input("数据库名 [aistoryforge]: ").strip() or "aistoryforge"
    db_user = input("数据库用户名 [aistoryforge]: ").strip() or "aistoryforge"
    db_password = getpass("数据库用户密码 [aistoryforge123]: ") or "aistoryforge123"
