...
from app.services.chapter_context_service import _build_full_book_context
...
def test_full_book_context_all_chapters_within_budget():
    ...
    text = _build_full_book_context(chapters, budget_chars=1000)
...
def test_full_book_context_over_budget_keeps_head_and_tail():
    ...
    text = _build_full_book_context(chapters, budget_chars=3000)
...
def test_full_book_context_empty_input():
    assert _build_full_book_context([], budget_chars=1000) == ""
...
def test_full_book_context_single_huge_chapter_not_truncated():
    ...
    text = _build_full_book_context(chapters, budget_chars=60000)
...
def test_full_book_context_summary_chain_tail_preference():
    ...
    text = _build_full_book_context(chapters, budget_chars=625)
...
def test_full_book_context_tail_skip_instead_of_break():
    ...
    text = _build_full_book_context(chapters, budget_chars=1000, tail_chapters=5)
